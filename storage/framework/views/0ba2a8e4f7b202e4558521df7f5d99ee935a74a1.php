<?php $__env->startSection('content'); ?>
   ...
   <?php endif; ?>
    ...
    <?php if(g('return_url')): ?>
   <p><a href='<?php echo e(g("return_url")); ?>'><i class='fa fa-chevron-circle-<?php echo e(trans('crudbooster.left')); ?>'></i> &nbsp; <?php echo e(trans('crudbooster.form_back_to_list',['module'=>urldecode(g('label'))])); ?></a></p>
    <?php endif; ?>
          ...
          <tbody>
            ...
            <tr>
              ...
              <?php echo e(ucwords(str_replace('_',' ',$c))); ?>
               ...
               <?php endif; ?>
              </strong></td><td> <?php echo e($parent_table->$c); ?></td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>            
          </tbody>
        </table>    
