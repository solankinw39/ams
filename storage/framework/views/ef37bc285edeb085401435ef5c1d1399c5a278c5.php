<div class='form-group <?php echo e($header_group_class); ?> <?php echo e(($errors->first($name))?"has-error":""); ?>' id='form-group-<?php echo e($name); ?>' style="<?php echo e(@$form['style']); ?>">
							...
							<input type='number' step="<?php echo e(($form['step'])?:'1'); ?>" title="<?php echo e($form['label']); ?>" <?php echo e($required); ?> <?php echo e($readonly); ?> <?php echo $placeholder; ?> <?php echo e($disabled); ?> <?php echo e($validation['min']?"min=$validation[min]":""); ?> <?php echo e($validation['max']?"max=$validation[max]":""); ?> class='form-control' name="<?php echo e($name); ?>" id="<?php echo e($name); ?>" value='<?php echo e($value); ?>'/>
