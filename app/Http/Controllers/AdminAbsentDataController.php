<?php namespace App\Http\Controllers;
	...
	class AdminAbsentDataController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Staffs","name"=>"divisions_id","join"=>"divisions,name"];
			$this->col[] = ["label"=>"Date","name"=>"recorddate"];
			$this->col[] = ["label"=>"Absent","name"=>"is_absent"];
