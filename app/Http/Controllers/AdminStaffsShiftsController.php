<?php namespace App\Http\Controllers;
	...
	class AdminStaffsShiftsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Shifts","name"=>"shifts_ids","join"=>"shifts,name"];
