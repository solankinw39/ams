<?php namespace App\Http\Controllers;
	...
	class AdminLeaveTypesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Is Carry Forword","name"=>"is_carry_forword"];
			$this->col[] = ["label"=>"Carry Forword To","name"=>"carry_forword_to"];
			$this->col[] = ["label"=>"Is Encash","name"=>"is_encash"];
			$this->col[] = ["label"=>"Encash After","name"=>"encash_after"];
