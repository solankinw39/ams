<?php namespace App\Http\Controllers;
	...
	class AdminDepartmentsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:departments','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
