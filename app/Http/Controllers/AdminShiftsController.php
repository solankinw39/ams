<?php namespace App\Http\Controllers;
	...
	class AdminShiftsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Shift Types","name"=>"shift_types_id","join"=>"shift_types,name"];
			$this->col[] = ["label"=>"Name","name"=>"name"];
			$this->col[] = ["label"=>"Start Time","name"=>"start_time"];
			$this->col[] = ["label"=>"End Time","name"=>"end_time"];
			$this->col[] = ["label"=>"Working Hours","name"=>"working_hours"];
