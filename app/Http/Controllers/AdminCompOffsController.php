<?php namespace App\Http\Controllers;
	...
	class AdminCompOffsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Worked On","name"=>"worked_on_date"];
			...
			$this->form[] = ['label'=>'Worked On Date','name'=>'worked_on_date','type'=>'date','validation'=>'required|date','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Approved On','name'=>'approved_on','type'=>'datetime','validation'=>'date_format:Y-m-d H:i:s','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Worked On Date","name"=>"worked_on_date","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
			...
			//$this->form[] = ["label"=>"Approved On","name"=>"approved_on","type"=>"datetime","required"=>TRUE,"validation"=>"required|date_format:Y-m-d H:i:s"];
