<?php namespace App\Http\Controllers;
	...
	class AdminAttendanceLogsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Date","name"=>"recorddate"];
			$this->col[] = ["label"=>"Time","name"=>"recordtime"];
			...
			$this->form[] = ['label'=>'Time','name'=>'recordtime','type'=>'time','validation'=>'required|date_format:H:i:s','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Device','name'=>'device_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'devices,id'];
			$this->form[] = ['label'=>'Status','name'=>'status','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Lattitude','name'=>'lattitude','type'=>'googlemaps','validation'=>'min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Longitude','name'=>'longitude','type'=>'googlemaps','validation'=>'min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Remark','name'=>'remark','type'=>'text','validation'=>'min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Shifts','name'=>'shifts_id','type'=>'select2','validation'=>'integer|min:0','width'=>'col-sm-10','datatable'=>'shifts,name'];
			$this->form[] = ['label'=>'From Ip','name'=>'from_ip','type'=>'text','validation'=>'min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Recordtime","name"=>"recordtime","type"=>"time","required"=>TRUE,"validation"=>"required|date_format:H:i:s"];
			...
			//$this->form[] = ["label"=>"Lattitude","name"=>"lattitude","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			...
			//$this->form[] = ["label"=>"From Ip","name"=>"from_ip","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
