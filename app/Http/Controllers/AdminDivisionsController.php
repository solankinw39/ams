<?php namespace App\Http\Controllers;
	...
	class AdminDivisionsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:divisions','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ['label'=>'Organizations','name'=>'organizations_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
