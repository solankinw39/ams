<?php namespace App\Http\Controllers;
	...
	class AdminAllowedLeavesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Leave Types","name"=>"leave_types_id","join"=>"leave_types,name"];
