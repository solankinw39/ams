<?php namespace App\Http\Controllers;
	...
	class AdminSubDivisionsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Head","name"=>"head","join"=>"staffs,name"];
			...
			$this->form[] = ['label'=>'Head','name'=>'head','type'=>'select2','validation'=>'min:1|max:255|integer','width'=>'col-sm-10','datatable'=>'staffs,name'];
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:sub_divisions','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			...
			//$this->form[] = ['label'=>'Departments','name'=>'departments_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'locations,name'];
			//$this->form[] = ['label'=>'Divisions','name'=>'divisions_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'departments,name'];
			//$this->form[] = ['label'=>'Name','name'=>'name','type'=>'text','validation'=>'required|string|min:3|max:70','width'=>'col-sm-10','datatable'=>'divisions,name'];
			//$this->form[] = ['label'=>'Head','name'=>'head','type'=>'select2','validation'=>'min:1|max:255|integer','width'=>'col-sm-10','datatable'=>'staffs,name'];
			//$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:sub_divisions','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			//$this->form[] = ['label'=>'Phone Number','name'=>'phone_number','type'=>'number','validation'=>'required|numeric','width'=>'col-sm-10','placeholder'=>'You can only enter the number only'];
			# OLD END FORM
